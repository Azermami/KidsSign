    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="Liste_des_signes.php" class="active">
        ...
        <div class="col-lg-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              ...
              <h5 class="card-title">Listes des Signes</h5>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">ID Signe</th>
                    <th scope="col">Mot en  Arabe</th>
                    <th scope="col">Mot en Francais</th>
                    <th scope="col">Image</th>
                    <th scope="col">Video</th>
                    <th scope="col">Tag </th>
                    <th scope="col">Id interpret</th>

                  </tr>
                </thead>
                <tbody>
                <?php include 'assets/php/liste_signes.php'; ?>
                </tbody>
              </table>
            </div>
          </div>
