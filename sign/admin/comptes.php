  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="charts-nav" class="nav-content collapse show  " data-bs-parent="#sidebar-nav">
        <li>
          <a href="Comptes.php" class="active">
        ...
        <div class="col-lg-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              ...
              <h5 class="card-title">Liste Des Comptes Des Interpretes</h5>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                <?php include 'assets/php/checkcompte.php'; ?>
        ...
        <div class="col-lg-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              ...
              <h5 class="card-title">Liste Des Comptes Des Parents</h5>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                <?php include 'assets/php/liste_comptes_parents.php'; ?>
