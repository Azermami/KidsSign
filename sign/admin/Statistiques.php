        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="Ajout_sign.php">
              <i class="bi bi-circle"></i><span>Ajout Signe</span>
            </a>
          </li>
          <li>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Bar Chart -->
              <?php include 'assets/php/barchart.php'; ?>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Pie Chart -->
              <?php include 'assets/php/piechart.php'; ?>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <?php include 'assets/php/donutchart.php'; ?>
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              ...
              <?php include 'assets/php/RadialBarChart.php'; ?>
