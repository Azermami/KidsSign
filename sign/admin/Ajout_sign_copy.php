  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="tables-nav" class="nav-content collapse  show " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="Ajout_sign.php" class="active">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"> Ajout d'un  signe</h5>

              <!-- General Form Elements -->
              <form  method="POST" action="assets/php/ajoutersigne.php">
              <?php
...
$sql = "SELECT mot FROM demande WHERE id_demande = " . mysqli_real_escape_string($conn, $_POST['id_demande']) . ";";
...
?>
  ...
  <div class="row mb-3">
    <label for="inputMotArabe" class="col-sm-2 col-form-label">Mot en Arabe</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputMotArabe" name="inputMotArabe" >
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputMotFrancais" class="col-sm-2 col-form-label">Mot en Français</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputMotFrancais" name="inputMotFrancais" value="<?php echo $mot; ?>">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputImage" class="col-sm-2 col-form-label">Image</label>
    <div class="col-sm-10">
      <input class="form-control" type="file" id="image" name="inputimage">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputVideo" class="col-sm-2 col-form-label">Video</label>
    <div class="col-sm-10">
      <input class="form-control" type="text" id="inputVideo" name="inputVideo" value="<?php echo $video; ?>">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputIDinterpret" class="col-sm-2 col-form-label">ID interpret</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="idinterpret" name="idinterpret"value="<?php echo $inputid_interpete; ?>">
    </div>
  </div>
  <div class="row mb-3">
    <label class="col-sm-2 col-form-label"><Table>Tag</Table></label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputtagg" name="inputtag">
    </div>
  </div>
  </div>
  <div class="row mb-3">
