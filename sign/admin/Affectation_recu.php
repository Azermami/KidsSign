  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="forms-nav" class="nav-content collapse show    " data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="Affectation_recu.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="col-12">
      <div class="card recent-sales overflow-auto">
        ...
        <div class="card-body">
          <h5 class="card-title">Liste Des Affectation Valider
          </h5>

          <table class="table table-hover">
                <thead>
                  <tr>
                    <th scope="col">ID demandes</th>
                    <th scope="col">ID Interpretes</th>
                ...
                <tbody>
            <?php include 'assets/php/Liste_des_Affectations_valider.php'; ?>
