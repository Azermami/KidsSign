...
<aside id="sidebar" class="sidebar">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputMotFrancais" name="inputMotFrancais">
    </div>
  </div>
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input class="form-control" type="file" id="inputVideo" name="inputVideo">
    </div>
  </div>
  <div class="row mb-3">
    <label for="inputIDinterpret" class="col-sm-2 col-form-label">ID interpret</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="idinterpret" name="idinterpret">
    </div>
  </div>
  <div class="row mb-3">
