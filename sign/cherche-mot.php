...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $id_signe = $_POST['signe'];

    $sql = "SELECT id_signe, mot_ar, mot_fr, image, video, tag, id_interpret FROM signe WHERE mot_fr = '$id_signe'";
    ...
    if ($result->num_rows > 0) {
      ...
      $message = "<center>Votre saisie n'existe pas </center>";
  }
...
<body>
  ...
  <header id="header">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.php">TifLy SiGn<span>.</span></a></h1>
    ...
    <section class="breadcrumbs">
      ...
      <?php if ($message) : ?>
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            <li><a href="index.php">TifLy SiGn</a></li>
