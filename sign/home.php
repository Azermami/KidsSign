...
<body>
  ...
  echo "Erreur lors de l'exécution de la requête : " . mysqli_error($conn);
    ...
    <?php while($row=mysqli_fetch_array($reps)) {?>
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $row['id'];?>">interpreter</button>
