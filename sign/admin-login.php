    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li><a class="nav-link scrollto" href="index.php?section=#about">A Propos</a></li>
          ...
          <!-- <li><a class="getstarted scrollto" href="forms-validation.php" target="_blank">Connexion</a></li> -->
        </ul>
          ...
          <div class="row justify-content-center">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate id="forms-validation" method="post" action="admin-log.php">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Nom d'utilisateur</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend"></span>
                        <input type="text" name="login" class="form-control" placeholder="Nom d'utilisateur" id="yourUsername" required>
